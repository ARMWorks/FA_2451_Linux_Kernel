/*
 * linux/drivers/char/mini2451_pwm.c
 *
...
#define BUZZER_PMW_GPIO			S3C2410_GPB(0)
...
static void pwm_stop(void) {
	s3c_gpio_cfgpin(BUZZER_PMW_GPIO, S3C_GPIO_INPUT);
...
static int mini2451_pwm_open(struct inode *inode, struct file *file) {
...
static int mini2451_pwm_close(struct inode *inode, struct file *file) {
	up(&lock);
	return 0;
}
...
static struct file_operations mini2451_pwm_ops = {
	.owner			= THIS_MODULE,
	.open			= mini2451_pwm_open,
	.release		= mini2451_pwm_close, 
	.unlocked_ioctl	= mini2451_pwm_ioctl,
};

static struct miscdevice mini2451_misc_dev = {
	.minor = MISC_DYNAMIC_MINOR,
	.name = DEVICE_NAME,
	.fops = &mini2451_pwm_ops,
};
...
module_init(mini2451_pwm_dev_init);
module_exit(mini2451_pwm_dev_exit);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("FriendlyARM Inc.");
MODULE_DESCRIPTION("FriendlyARM Mini2451 PWM Driver");
